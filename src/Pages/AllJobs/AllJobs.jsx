                ...
                <div className="overflow-x-auto mb-10 border rounded-xl p-4">
                    <form className="flex items-center justify-center ">
                        <label className="input input-bordered flex items-center gap-2 my-4">
                            ...
                            <input type="text" className="w-96" placeholder="Enter Job Title" />
                        ...
                        {/* <div className='flex items-end justify-end p-1 overflow-hidden border rounded-lg w-1/2 focus-within:ring focus-within:ring-opacity-40 focus-within:border-blue-400 focus-within:ring-blue-300'>
                            <input
